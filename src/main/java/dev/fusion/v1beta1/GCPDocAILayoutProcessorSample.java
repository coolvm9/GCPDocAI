...
public class GCPDocAILayoutProcessorSample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int chunkSize = 1000; // Set the chunk size for layout analysis
    ...
    public static Document processDocument(ByteString pdfBytes, String projectId, String location, String processorId, int chunkSize) throws IOException {
